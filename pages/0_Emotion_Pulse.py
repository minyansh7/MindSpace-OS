...
def run():
    ...
    render_hero(
        ...
        description="This emotional map reveals how people express their emotions through meditation practices, drawn from Reddit posts and comments shared between January 2024 and June 2025.",
    )
